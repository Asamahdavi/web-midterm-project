  ...
  return (
      ...
      <section className="overflow-hidden">
        <div className="container grid sm:grid-cols-1 xl:grid-cols-2 space-x-24 px-12">
          <div className="item text-left py-4 space-y-3 mb-2">
            ...
            <h4>Buffalo, USA</h4>
            <h3 className="font-bold text-black ">office@enfold-minimal.com</h3>
            ...
            <form className="item w-4/5  justify-between">
              ...
              <div className="grid grid-cols-2 items-start justify-between space-x-3">
                <div className="">
                  <div className="py-1 ">
                    <input
                      className="bg-gray-200 rounded-sm appearance-none  border border-solid border-gray-300   w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-700"
                      id="inline-full-name"
                      type="text"
                      placeholder="Name*"
                    />
                ...
                <div>
                  <div className="py-1 ">
                    <input
                      className="bg-gray-200 rounded-sm border border-solid border-gray-300 appearance-none   w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-700"
                      id="inline-password"
                      type="text"
                      placeholder="Email*"
                    />
    ...
    "
              ...
              <div className="items-start flex py-4 ">
                <button
                  className="shadow left-0 rounded-sm bg-black hover:bg-violet-300 hover:text-black focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 "
                  type="button"
                >
                  Submit
                </button>
