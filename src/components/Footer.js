...
<>
  ...
  <section>
    ...
    <ReactTooltip id="registerTip" place="top" effect="solid">
      ...
      <img className="m-2" alt="img"src={fsIcon} width="25" height="20"/>
      ...
      <h4 className="text-gray-400 m-2" >Get our latest news, tips and tricks</h4>
        ...
        <div className="inline-flex space-x-1 m-8"> 
            <input className="appearance-none  py-2 px-10 block w-full bg-white text-gray-700 border border-black  
              leading-tight focus:outline-none focus:bg-white" id="grid-first-name" type="text"  placeholder="E-Mail"/>
      ...
      <a className="text-gray-400" href="https://kriesi.at/themes/enfold-elegant-portfolio/#"> About &nbsp;</a>
       
      <a className="text-gray-400" href="https://kriesi.at/themes/enfold-elegant-portfolio/#">|
        Imprint &nbsp;
      </a>
       
      <a className="text-gray-400" href="https://kriesi.at/themes/enfold-elegant-portfolio/">| Contact&nbsp; </a>
       
      <a className="text-gray-400" href="https://kriesi.at/privacy-policy">| Privacy Policy </a>
      </div>
